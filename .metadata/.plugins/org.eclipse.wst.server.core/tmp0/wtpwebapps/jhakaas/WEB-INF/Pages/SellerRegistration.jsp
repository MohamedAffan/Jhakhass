			...
			<div class="col-md-8">
				<section>
					<h1 class="entry-title">
						<span>SellerRegistration</span>
					</h1>
					<hr>
					<form:form action="sellerreg" modelAttribute="addsell" class="form-horizontal"
						...
						<div class="form-group">
							<label class="control-label col-sm-3">SellerProductdetails <span
								class="text-danger">*</span></label>
