...
<!-- <script
	...
	var sl=${supplierlist}
	var cl=${categorylist}
	angular.module('jhakaas',[]).controller('ProductController',function($scope)
	{
...
<body style="background-color: white">
	...
	<div ng-app="jhakaas" ng-controller="ProductController">
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				<section>
					...
					<form:form action="Product" modelAttribute="addsell" class="form-horizontal"
						...
						<div class="form-group">
							<label class="control-label col-sm-3">ProductId<span
								class="text-danger">*</span></label>
							<div class="col-md-5 col-sm-8">
								<div class="input-group">
									<form:input type="text" class="form-control" name="ProductId"
										id="ProductId" placeholder="ProductId"
										value="" path="ProductId"></form:input>
								</div>
							</div>
						</div>
						  ...
						  <div class="form-group" style="margin-top: 20">
								<div class="col-xs-offset-3 col-xs-10">
									...
									<button name="Reset" type="reset" value="Reset"
										class="btn btn-danger"> Place Order
									</button>
								</div>
							</div>        
					</form:form>
